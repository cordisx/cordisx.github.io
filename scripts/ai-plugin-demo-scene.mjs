...
export const aiPluginDemoScene = Object.freeze({
  ...
  timeline: Object.freeze([
    ...
    Object.freeze({
      type: 'type-composer',
      id: 'proof-message',
      text: AI_PLUGIN_DEMO_PROOF_MESSAGE,
      framesPerCharacter: 2,
    }),
    Object.freeze({ type: 'click-native-submit', id: 'submit-proof' }),
    Object.freeze({
      type: 'wait-selector',
      id: 'fullscreen-confetti',
      selector: '[data-cordisx-effect="confetti"]',
      maximumSourceSeconds: 10,
    }),
    Object.freeze({ type: 'hold', id: 'confetti-visible', frames: 42 }),
    Object.freeze({
      type: 'wait-selector-removed',
      id: 'confetti-cleared',
      selector: '[data-cordisx-effect="confetti"]',
      maximumSourceSeconds: 8,
    }),
